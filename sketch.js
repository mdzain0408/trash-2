...
function setup() {
	...
	ww1 = createSprite(0,0,10,100);
	ww2 = createSprite(0,0,10,100);
	...
	w1 =Bodies.rectangle(1000,120,10,90,{isStatic : true});
	World.add(world, w1);
	w2 =Bodies.rectangle(1200,120,10,90,{isStatic : true});
	World.add(world, w2);
